...
var SLIDE_CLASSES = ['far-past', 'past', 'past2', 'current', 'next', 'next2', 'far-next'];
...
function setTimer(slideNo) {
    var el = getSlideEl(slideNo),div,min,sec,m,s,interval;
    if(el.classList.contains('countdown')) {
        el.innerHTML = '';
        div = document.createElement('div'),
        min = document.createElement('span'),
        sec = document.createElement('span'),
        m = parseFloat(el.dataset.duration.substr(0, 2)),
        s = parseFloat(el.dataset.duration.substr(-2, 2)),

        div.appendChild(min);
        div.appendChild(document.createTextNode(':'));
        div.appendChild(sec);
        min.innerText = ('0' + m).substr(-2,2);
        sec.innerText = ('0' + s).substr(-2,2);
        el.appendChild(div);
  ...
  for (var i = 0; i < slideEls.length; i++) {
    switch (i) {
      case curSlide - 2:
        ...
        break;
      case curSlide - 1:
         updateSlideClass(i,direction == RIGHT ? 'past' : 'past2');
        break;
      case curSlide: 
        ...
        break;
      case curSlide + 1:
        updateSlideClass(i, direction == RIGHT ? 'next' : 'next2');      
        break;
      case curSlide + 2:
